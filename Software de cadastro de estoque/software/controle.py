...
def editar():
    ...
    editar.txtAlterarItem.setText(str(leitura_banco[0][1]))
...
def salvar_dados():
    ...
    produto = editar.txtAlterarItem.text()
    preco = editar.txtAlterarPreco.text()
    estoque = editar.txtAlterarQuantidade.text()
...
formulario.btnEstoque.clicked.connect(lista)
